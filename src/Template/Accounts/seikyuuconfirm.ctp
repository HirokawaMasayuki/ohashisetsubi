...
<table width="1300" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#E6FFFF">
  <tr style="background-color: #E6FFFF">
    <td>
        ...
        <table align="center">
          ...
          <tr>
            ...
            <td align="center" bgcolor="#FFFFCC" style="padding: 0.2rem"><?= h($kurikosi) ?></td>
            ...
            <td align="center" bgcolor="#FFFFCC" style="padding: 0.2rem"><?= h($totalseikyuu) ?></td>
          </tr>
        </table>
        <br>
        <br>
    ...
    <br>
        ...
        <tr bgcolor="#E6FFFF" >
          <td align="left" rowspan="2" width="30" bgcolor="#E6FFFF" style="border: none"><div align="center"><?= $this->Form->submit(__('請求書出力'), array('name' => 'confirm')); ?></div></td>
        </tr>
        </table>
