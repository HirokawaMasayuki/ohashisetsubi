    ...
    <td>
        ...
        <table align="center">
          <tr>
            ...
            <td align="center" width="30" bgcolor="#FFFFCC" style="font-size: 12pt;padding: 0.2rem"><strong style="font-size: 11pt">税率</strong></td>
      ...
      <?php for ($i=0;$i<count($Uriagesyousais);$i++): ?>
        ...
        <?php endif; ?>
        <td  align="center"  bgcolor="#FFFFCC" style="padding: 0.2rem"><?= h($Uriagesyousais[$i]["zeiritu"]) ?></td>
