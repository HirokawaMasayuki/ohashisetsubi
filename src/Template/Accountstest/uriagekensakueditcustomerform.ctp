...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#E6FFFF">
  <tr style="background-color: #E6FFFF">
    <td>
        ...
        <?= $this->Form->create($uriages, ['url' => ['action' => 'uriagekensakueditcustomerconfirm']]) ?>
        ...
        <br>
        <legend align="center"><strong style="font-size: 11pt;color: red"><?= __("変更後の顧客名を入力してください。") ?></strong></legend>
        <br>
        <table align="center">
          <tr>
          ...
          <tr>
            <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->input('name', array('type'=>'text', 'label'=>false, 'id'=>"Customer_list", 'size'=>70)) ?></td>
          </tr>
        </table>
        <br>
        <br>
    ...
    <br>
    <br>
    <?= $this->Form->control('UriagemastersId', array('type'=>'hidden', 'value'=>$UriagemastersId, 'label'=>false)) ?>
