...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#E6FFFF">
  <tr style="background-color: #E6FFFF">
    <td>
        ...
        <?= $this->Form->create($Customer, ['url' => ['action' => 'seikyuusakiformsyousai']]) ?>
        <br>
        <legend align="center"><strong style="font-size: 13pt"><?= __("顧客選択") ?></strong></legend>
        <br>
        <legend align="center"><strong style="font-size: 11pt;color: red"><?= __("請求先を登録する顧客名を選択または入力してください。") ?></strong></legend>
        <br>
