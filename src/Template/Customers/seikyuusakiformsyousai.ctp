...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#E6FFFF">
  <tr style="background-color: #E6FFFF">
    <td>
        ...
        <?= $this->Form->create($Customer, ['url' => ['action' => 'seikyuusakiformsyousaiconfirm']]) ?>
        <br>
        <table align="center">
          <tr>
          ...
          <br>
          <legend align="center"><strong style="font-size: 11pt;color: red"><?= __("請求先を選択または入力してください。") ?></strong></legend>
          <br>
          ...
          <table align="center">
            ...
            <tr>
              <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->input('name2', array('type'=>'text', 'label'=>false, 'value'=>"", 'id'=>"Customer_list", 'size'=>70)) ?></td>
            </tr>
          </table>
          <br>
  ...
  <?= $this->Form->control('customeroya', array('type'=>'hidden', 'value'=>$namehyouji, 'label'=>false)) ?>
