...
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
  <tr bgcolor="#E6FFFF" >
    ...
    <td width="40"></td>
    <td style="border-style: none;"><div align="center"><?= $this->Form->submit('エクセル出力', array('name' => 'output')); ?></div></td>
  </tr>
</table>
</fieldset>
<br>
  ...
  <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: 0px;border-width: 1px">
        <thead>
            <tr border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC">
              ...
              <td width="160" height="30" colspan="20" nowrap="nowrap"><div align="center"><strong style="font-size: 11pt">顧客</strong></div></td>
              <td width="80" height="30" colspan="20" nowrap="nowrap"><div align="center"><strong style="font-size: 11pt">行No.</strong></div></td>
        ...
        <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC">
          ...
          <tr>
            <td style="border-bottom: 0px;border-width: 1px" align="center" colspan="20" nowrap="nowrap"><font><?= h($Uriages->delete_flag) ?></font></td>
