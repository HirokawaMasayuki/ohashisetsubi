...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#E6FFFF">
  <tr style="background-color: #E6FFFF">
    <td>
        ...
        <br>
        <legend align="center"><strong style="font-size: 12pt;color: black"><?= __("以下の内容で登録します。よろしければ登録ボタンを押してください。") ?></strong></legend>
        <br>
    ...
    <br>
      ...
      <br>
        ...
        <tr bgcolor="#E6FFFF" >
          ...
          <td align="center" rowspan="2" width="30" bgcolor="#E6FFFF" style="border: none"><div align="center"><?= $this->Form->submit(__('登録'), array('name' => 'confirm')); ?></div></td>
        </tr>
        </table>
        <br>
        <br>
...
<?= $this->Form->control('date_seikyuu', array('type'=>'hidden', 'value'=>$date_seikyuu, 'label'=>false)) ?>
