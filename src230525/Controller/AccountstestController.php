...
class AccountstestController extends AppController
{
		...
		*/
		if(isset($data["tugihe"])){
			...
			for($i=1; $i<=$data["tuika"]; $i++){
				...
				${"arr_".$i} = array('pro' => $data["pro_".$i],'amount' => $data["amount_".$i],'tani' => $data["tani_".$i],'tanka' => $data["tanka_".$i],'zeiritu' => $data["zeiritu_".$i],
