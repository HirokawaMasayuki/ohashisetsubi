...
class ShinkiesController extends AppController {
  ...
  //     $sample = array_merge($sample,array('seikyuusakicustomerId'=>0));
...
/*
  ...
  */
    ...
    //    $Suppliers = $this->Suppliers->patchEntities($this->Suppliers->newEntity(), $arrFp);
      //  $this->Suppliers->saveMany($Suppliers);
...
//     $fp = fopen("uriage10001-20000.csv", "r");//csvファイルはwebrootに入れる
//     $fpcount = fopen("uriage10001-20000.csv", 'r' );
//     $fp = fopen("uriage20001-30000.csv", "r");//csvファイルはwebrootに入れる
//     $fpcount = fopen("uriage20001-30000.csv", 'r' );
//     $fp = fopen("uriage30001-40000.csv", "r");//csvファイルはwebrootに入れる
//     $fpcount = fopen("uriage30001-40000.csv", 'r' );
//     $fp = fopen("uriage40001-50000.csv", "r");//csvファイルはwebrootに入れる
//     $fpcount = fopen("uriage40001-50000.csv", 'r' );
//     $fp = fopen("uriage50001-60000.csv", "r");//csvファイルはwebrootに入れる
//     $fpcount = fopen("uriage50001-60000.csv", 'r' );
//      $fp = fopen("uriage60000-.csv", "r");//csvファイルはwebrootに入れる
//      $fpcount = fopen("uriage60000-.csv", 'r' );
