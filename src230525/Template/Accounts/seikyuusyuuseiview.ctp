...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#E6FFFF">
  <tr style="background-color: #E6FFFF">
    <td>
        ...
        <?= $this->Form->create($nyuukins, ['url' => ['action' => 'seikyuusyuuseidelete']]) ?>
  ...
  <br>
    ...
    <table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
    <tr bgcolor="#E6FFFF" >
      <td align="left" rowspan="2" width="30" bgcolor="#E6FFFF" style="border: none"><div align="center"><?= $this->Form->submit(__('請求取り消し'), array('name' => 'confirm')); ?></div></td>
    </tr>
    </table>
    <br>
    ...
    <?= $this->Form->control('month', array('type'=>'hidden', 'value'=>$month, 'label'=>false)) ?>
