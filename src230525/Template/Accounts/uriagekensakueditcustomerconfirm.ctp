...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#E6FFFF">
  <tr style="background-color: #E6FFFF">
    <td>
        ...
        <?= $this->Form->create($uriages, ['url' => ['action' => 'uriagekensakueditcustomerdo']]) ?>
        ...
        <br>
        <legend align="center"><strong style="font-size: 13pt;color: red"><?= __("以下のように変更します。よろしければ決定ボタンを押してください。") ?></strong></legend>
        <br>
    ...
    <?= $this->Form->control('Customersnewid', array('type'=>'hidden', 'value'=>$Customersnewid, 'label'=>false)) ?>
