    ...
    <td>
        ...
        <table align="center">
          <tr>
            ...
            <td align="center" width="180" bgcolor="#FFFFCC" style="font-size: 12pt;padding: 0.2rem"><strong style="font-size: 11pt">請求額合計</strong></td>
            <td align="center" width="180" bgcolor="#FFFFCC" style="font-size: 12pt;padding: 0.2rem"><strong style="font-size: 11pt">小切手等合計</strong></td>
            <td align="center" width="180" bgcolor="#FFFFCC" style="font-size: 12pt;padding: 0.2rem"><strong style="font-size: 11pt">入金額合計</strong></td>
            <td align="center" width="180" bgcolor="#FFFFCC" style="font-size: 12pt;padding: 0.2rem"><strong style="font-size: 11pt">残金合計</strong></td>
            <td align="center" width="180" bgcolor="#FFFFCC" style="font-size: 12pt;padding: 0.2rem"><strong style="font-size: 11pt">繰越額合計</strong></td>
          </tr>
          <tr>
            <td align="center" bgcolor="#FFFFCC" style="padding: 0.2rem"><div align="center"><?= h($date_y."年".$date_m."月分") ?></div></td>
            <td align="center" bgcolor="#FFFFCC" style="padding: 0.2rem"><div align="center"><?= h(number_format($totalkingaku)." 円") ?></div></td>
            <td align="center" bgcolor="#FFFFCC" style="padding: 0.2rem"><div align="center"><?= h(number_format($totalkogitte)." 円") ?></div></td>
            <td align="center" bgcolor="#FFFFCC" style="padding: 0.2rem"><div align="center"><?= h(number_format($totalnyuukin)." 円") ?></div></td>
            <td align="center" bgcolor="#FFFFCC" style="padding: 0.2rem"><div align="center"><?= h(number_format($totalzandaka)." 円") ?></div></td>
            <td align="center" bgcolor="#FFFFCC" style="padding: 0.2rem"><div align="center"><?= h(number_format($totalkurikosi)." 円") ?></div></td>
          </tr>
        </table>
  ...
  <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: 0px;border-width: 1px">
        ...
        <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC">
          ...
          <tr>
            ...
            <?php if($arrSeikyuu[$i]["kurikosi"] > 0): ?>
            <td style="border-bottom: 0px;border-width: 1px" align="center" colspan="20" nowrap="nowrap"><font style="font-size: 10pt"><?= h(number_format($arrSeikyuu[$i]["kurikosi"])) ?></font></td>
          <?php else: ?>
          ...
          <?php if($arrSeikyuu[$i]["seikyuugaku"] > 0): ?>
          <td style="border-bottom: 0px;border-width: 1px" align="center" colspan="20" nowrap="nowrap"><font style="font-size: 10pt"><?= h(number_format($arrSeikyuu[$i]["seikyuugaku"])) ?></font></td>
        <?php else: ?>
        ...
        <?php endif; ?>
            ...
            <?php if($arrSeikyuu[$i]["sousai"] > 0): ?>
            <td style="border-bottom: 0px;border-width: 1px" align="center" colspan="20" nowrap="nowrap"><font style="font-size: 10pt"><?= h(number_format($arrSeikyuu[$i]["sousai"])) ?></font></td>
          <?php else: ?>
          ...
          <?php endif; ?>
            ...
            <?php if($arrSeikyuu[$i]["nyuukingaku"] > 0): ?>
            <td style="border-bottom: 0px;border-width: 1px" align="center" colspan="20" nowrap="nowrap"><font style="font-size: 10pt"><?= h(number_format($arrSeikyuu[$i]["nyuukingaku"])) ?></font></td>
          <?php else: ?>
          ...
          <?php if($arrSeikyuu[$i]["tyousei"] > 0): ?>
          <td style="border-bottom: 0px;border-width: 1px" align="center" colspan="20" nowrap="nowrap"><font style="font-size: 10pt"><?= h(number_format($arrSeikyuu[$i]["tyousei"])) ?></font></td>
        <?php else: ?>
        ...
        <?php if($arrSeikyuu[$i]["zandaka"] > 0): ?>
        <td style="border-bottom: 0px;border-width: 1px" align="center" colspan="20" nowrap="nowrap"><font style="font-size: 10pt"><?= h(number_format($arrSeikyuu[$i]["zandaka"])) ?></font></td>
      <?php else: ?>
