...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#E6FFFF">
  <tr style="background-color: #E6FFFF">
    <td>
        ...
        <?= $this->Form->create($nyuukins, ['url' => ['action' => 'nyuukinsyoukaiseikyuuitiran']]) ?>
        <br>

<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
  <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: 0px;border-width: 1px">
    <tr style="border-bottom: 0px;border-width: 0px">
      <td style='border-bottom: 0px;border-width: 1px'  bgcolor="#FFFFCC" colspan="80"  height='50'  nowrap="nowrap"><div align="center"><strong style="font-size: 12pt">入金日絞り込み</strong></div></td>
    </tr>
