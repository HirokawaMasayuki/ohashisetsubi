  ...
  <tr style="background-color: #E6FFFF">
    <td>
          ...
          <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: 0px;border-width: 1px">
                <thead>
                    <tr border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC">
                      ...
                      <td align="center" width="350" bgcolor="#FFFFCC" style="font-size: 12pt;padding: 0.2rem"><strong style="font-size: 11pt">品名（現場名）</strong></td>
        ...
        <tr bgcolor="#E6FFFF" >
          ...
          <td style="border: none"><div align="center"><?= $this->Form->submit(__('決定'), array('name' => 'zenkaikobetu')); ?></div></td>
        </tr>
        </table>
        <br>
        <br>
        ...
        <?= $this->Form->control('zenkaikobetu', array('type'=>'hidden', 'value'=>$id, 'label'=>false)) ?>
