...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#E6FFFF">
  <tr style="background-color: #E6FFFF">
    <td>
        ...
        <table align="center">
          ...
          <tr>
            ...
            <td  align="center" width="80" bgcolor="#FFFFCC" style="padding: 0.2rem"><?= h($keisyou) ?></td>
          </tr>
        </table>
        <br>
        <table align="center">
      ...
      <?php for ($i=0;$i<count($Uriagesyousais);$i++): ?>
              ...
              <td bgcolor="#FFFFCC" style="padding: 0.2rem"><?= $this->Form->input('pro_'.$i, array('type'=>'text', 'label'=>false, 'value'=>$Uriagesyousais[$i]->pro)) ?></td>
                ...
                <td bgcolor="#FFFFCC" style="padding: 0.2rem; width:50">
                  <?= $this->Form->input('zeiritu_'.$i, ["type"=>"select", "options"=>$arrZeiritu, 'value'=>$Uriagesyousais[$i]->zeiritu, 'label'=>false]) ?>
                </td>
    ...
    <tr bgcolor="#E6FFFF" >
      ...
      <td align="right" rowspan="2" width="20" bgcolor="#E6FFFF" style="border: none">　　</td>
      <td align="right" rowspan="2" width="50" bgcolor="#E6FFFF" style="border: none"><div align="right"><?= $this->Form->submit(__('空白行追加'), array('name' => 'zenkai3')); ?></div></td>
      <td align="right" rowspan="2" width="20" bgcolor="#E6FFFF" style="border: none">　　　　</td>
