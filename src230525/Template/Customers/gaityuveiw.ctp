...
<table align="center" border="2" bordercolor="#E6FFFF" cellpadding="0" cellspacing="0">
  <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC" style="border-bottom: solid;border-width: 1px">
        <thead>
          <tr>
            <td align="center" width="350" bgcolor="#FFFFCC" style="font-size: 12pt;padding: 0.2rem"><strong style="font-size: 11pt">外注先</strong></td>
        ...
        <tbody border="2" bordercolor="#E6FFFF" bgcolor="#FFFFCC">
          ...
          <tr>
            ...
            <td align="center" width="150" bgcolor="#FFFFCC" style="font-size: 12pt;padding: 0.2rem"><?= h($Suppliers->tel) ?></td>
            <td align="center" width="400" bgcolor="#FFFFCC" style="font-size: 12pt;padding: 0.2rem"><?= h($Suppliers->address) ?></td>
          </tr>
          <?php endforeach; ?>
        </tbody>
    </table>
